...
sed -i '58  a\<user username="tomcat" password="ritesh123" roles="manager-gui, manager-script"/>' apache-tomcat-9.0.115/conf/tomcat-users.xml
...
sudo sh apache-tomcat-9.0.115/bin/startup.sh
