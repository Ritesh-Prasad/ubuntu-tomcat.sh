...
wget https://dlcdn.apache.org/tomcat/tomcat-9/v9.0.115/bin/apache-tomcat-9.0.117.tar.gz
...
sed -i '58  a\<user username="tomcat" password="ritesh123" roles="manager-gui, manager-script"/>' apache-tomcat-9.0.117/conf/tomcat-users.xml
...
sudo sh apache-tomcat-9.0.117/bin/startup.sh
